...
class OpenDoor(MujocoEnv, EzPickle):
    metadata = {
        "render_modes": [
            "human",
            "rgb_array",
    ...
    def step(self, a):
        ...
        goal_achieved = True if goal_distance >= 1.0 else False
        ...
        if goal_achieved:
            ...
            # get to handle
            reward = 3 * -np.linalg.norm(palm_pos - handle_pos)
            # open door
...
environment_name = "OpenDoor-v1"
checkpoint_path = "/Users/eirinipanteli/PycharmProjects/robotic-hand-simulations/Simulations/OpenDoor/Checkpoints/PPO_checkpoint_seed_1.pth"
save_path = "OpenDoor"
train(environment_name, save_path, episode_steps=350, csv_filename='PPO_episode_score_experiment_3.csv',
      checkPoint_name="PPO_checkpoint_experiment_3", stop_episodes=250)
# continue_train(environment_name, checkpoint_path, save_path, current_best_reward=10.0, episode_steps=350)
# save_path = "/Users/eirinipanteli/PycharmProjects/robotic-hand-simulations/Simulations/OpenDoor/REINFORCE_test.csv"
# test(environment_name, checkpoint_path, save_path, episode_steps=350, total_num_episodes=10, )
