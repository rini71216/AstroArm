...
class Drill(MujocoEnv, EzPickle):
    ...
    def step(self, a):
        ...
        goal_achieved = True if goal_distance1 >= 0.057 else False
...
environment_name = "Drill_Step2-v1"
save_path = ""
checkpoint_path = "/Users/eirinipanteli/PycharmProjects/robotic-hand-simulations/Simulations/Drill/Step_2/Checkpoints/PPO_checkpoint_seed_1.pth"
# train(environment_name, save_path, episode_steps=100)
# continue_train(environment_name, checkpoint_path, save_path)
